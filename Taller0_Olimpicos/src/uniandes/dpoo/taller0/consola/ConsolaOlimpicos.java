...
public class ConsolaOlimpicos
{
	...
	private void ejecutarDarPaisDelAtleta()
	{
		String atleta = input("Por favor ingrese el nombre del Atleta del que desea conocer su nacionalidad");
		if (atleta != null)
		{
			String paisAtleta = calculadora.paisDelAtleta(atleta);
			System.out.println("el pais del atleta" + atleta +" es: "+ paisAtleta);
		}
	}
	/**
